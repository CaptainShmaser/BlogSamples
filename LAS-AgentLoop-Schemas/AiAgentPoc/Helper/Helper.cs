...
namespace AiGentPoc
{
    ...
    /// <summary>
    /// Represents the Helper flow invoked function.
    /// </summary>
    public class Helper
    {
        ...
        {
            logger = loggerFactory.CreateLogger<Helper>();
        }
        ...
        {
            this.logger.LogInformation("Starting Helper with Zip Code: " + zipCode + " and Scale: " + temperatureScale);
        ...
        /// <summary>
        /// Represents the weather information for Helper.
        /// </summary>
